...
public abstract class CommandLineCompiler extends AbstractCompiler {
   ...
   abstract protected void addImpliedArgs(Vector args, 
                                          boolean debug,
   ...
   protected CompilerConfiguration createConfiguration(final CCTask task,
	...
	int cores = specificDef.getCores(defaultProviders, 1);
        this.addImpliedArgs(args, debug, multithreaded, exceptions, linkType, rtti, optimization, cores);
